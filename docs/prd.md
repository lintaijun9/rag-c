...
- **框架**: next.js
- **AI SDK**: @google/genai
- **流式处理**: [streamdown](https://streamdown.ai/)
- **配置管理**: dotenv / config
...
https://ai.google.dev/api/file-search/documents.md.txt
https://ai.google.dev/api/file-search/file-search-stores.md.txt
https://ai.google.dev/gemini-api/docs/file-search.md.txt
gemini file search api 参考文档：
1. @/gemini/gemini-file-search.md
2. @/gemini/file-search-stores.md
3. @/gemini/file-search-documents.md
